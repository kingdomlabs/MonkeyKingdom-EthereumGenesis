...
import "./interfaces/IMKGenesis.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/security/ReentrancyGuardUpgradeable.sol";
import "hardhat/console.sol";

contract MKGenesisStakingV1F is
    Initializable,
    OwnableUpgradeable,
    ReentrancyGuardUpgradeable
{
    IMKGenesis public mk;
    IMKGenesis public db;
    IPeach public peach;
    ...
    function initialize(
        ...
        mk = IMKGenesis(mkAddr);
        db = IMKGenesis(dbAddr);
    ...
    function stake(
        ...
        for (uint256 i = 0; i < tokenIDs.length; i++) {
            if (isBaepe(tokenIDs[i])) {
                ...
                require(db.ownerOf(dbID) == msg.sender, "Owner check failed");
                db.lock(dbID);
            } else {
                require(
    ...
    function claim(uint256[] calldata tokenIDs) public virtual nonReentrant {
